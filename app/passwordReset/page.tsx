                            ...
                            .then((data) => {
                                ...
                                if (data.status == "success") {
                                    fetch(
                                        ...
                                        <a href="https://3dprinting.garrendiab.co.za/passwordReset/${data.userId}" style="display:block;background-color:#0855c9;width:80%;max-width:120px;margin:10px auto;color:white;border-radius:5px;text-align:center;padding:5px 15px;">Reset Password</a>
